  ...
  methods: {
    ...
    batchRemove() {
      ...
      this.$confirm('此操作将永久删除这些角色, 是否继续?', '提示', {
        ...
        api.deleteBatchRoleByIds(ids).then(response => {
          // a.给出提示
          this.$message({
            type: 'success',
            message: '删除成功!'
    ...
    removeDataById(id) {
      this.$confirm('此操作将永久删除该角色, 是否继续?', '提示', {
        ...
        api.deleteRoleById(id).then(response => {
          // a.给出提示
          this.$message({
            type: 'success',
            message: '删除成功!'
    ...
    addRole() {
      api.addByRole(this.sysRole).then(response => {
        // 给出提示框
    ...
    updateRole() {
      ...
      api.updateByRole(this.sysRole).then(response => {
        // 给出提示框
