                ...
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="分类名称">
                            <el-input style="width: 100%" v-model="searchObj.name" placeholder="分类名称" clearable></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
    ...
    methods: {
        ...
        batchRemove() {
            ...
            this.$confirm('此操作将永久删除这些角色, 是否继续?', '提示', {
                ...
                api.deleteBatchCategoryByIds(ids).then(response => {
                    // a.给出提示
                    this.$message({
                        type: 'success',
                        message: '删除成功!'
        ...
        removeDataById(id) {
            this.$confirm('此操作将永久删除该分类, 是否继续?', '提示', {
                ...
                api.deleteCategoryById(id).then(response => {
                    // a.给出提示
                    this.$message({
                        type: 'success',
                        message: '删除成功!'
